module module_fourier
  ...
  contains
    ...
    subroutine set_sh_grid
      ...
      ! greater than or equal to 2*lmax
    ...
    subroutine coefs_from_fun(lmax,data,coefs)
    ...
    subroutine coefs_from_fun_ten_tl(lmax,tens,coefs)
    ...
    subroutine coefs_from_fun_parr(lmax,data,coefs)
    ...
    subroutine zero_coef_from_fun(lmax,data,coef)
    ...
    subroutine fun_from_coefs(lmax,coefs,displ)
    ...
    subroutine fun_from_coefs_parr(lmax,coefs,displ)
    ...
    subroutine fun_from_coefs_ten(lmax,coefs,tens)
    ...
    subroutine fun_from_coefs_ten_tl(lmax,coefs,tens)
